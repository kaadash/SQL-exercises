...
CREATE TABLE ZESPOLY
	...
	NAZWA VARCHAR(20),
	ADRES VARCHAR(20),
	CONSTRAINT PK_ZESP PRIMARY KEY (ID_ZESP) );

CREATE TABLE ETATY
      ( NAZWA VARCHAR(10),
	PLACA_MIN FLOAT(6,2),
	PLACA_MAX FLOAT(6,2),
	CONSTRAINT PK_ETAT PRIMARY KEY(NAZWA));
...
CREATE TABLE PRACOWNICY
	...
	PLACA_DOD FLOAT(6,2),
	ID_ZESP INT(4),
	CONSTRAINT PK_PRAC PRIMARY KEY(ID_PRAC),
	CONSTRAINT FK_ID_ZESP FOREIGN KEY(ID_ZESP) REFERENCES ZESPOLY(ID_ZESP),
	CONSTRAINT MIN_PLACA_POD CHECK(PLACA_POD>100),
	CONSTRAINT FK_ID_SZEFA FOREIGN KEY(ID_SZEFA) REFERENCES PRACOWNICY(ID_PRAC),
	CONSTRAINT FK_ETAT FOREIGN KEY(ETAT) REFERENCES ETATY(NAZWA));
